...
var HealthMock = (function (_super) {
    __extends(HealthMock, _super);
    function HealthMock() {
     ...
     */
    HealthMock.prototype.isAvailable = function () {
     ...
     * @return {Promise<any>}
     */
    HealthMock.prototype.promptInstallFit = function () {
        return new Promise(function (resolve, reject) {
            resolve();
        });
    };
     ...
     * @return {Promise<any>}
     */
    HealthMock.prototype.requestAuthorization = function (datatypes) {
        return new Promise(function (resolve, reject) {
            resolve();
        });
    };
     ...
     */
    HealthMock.prototype.isAuthorized = function (datatypes) {
        return new Promise(function (resolve, reject) {
            resolve(true);
        });
    };
     ...
     */
    HealthMock.prototype.query = function (queryOptions) {
        var response;
        return new Promise(function (resolve, reject) {
            resolve(response);
        });
     ...
     * @return {Promise<HealthData[]>}
     */
    HealthMock.prototype.queryAggregated = function (queryOptionsAggregated) {
        var response;
        return new Promise(function (resolve, reject) {
            resolve(response);
        });
     ...
     * @return {Promise<any>}
     */
    HealthMock.prototype.store = function (storeOptions) {
        return new Promise(function (resolve, reject) {
            resolve();
        });
    };
