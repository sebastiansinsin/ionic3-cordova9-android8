...
var PlatformMock = /** @class */ (function () {
    ...
    PlatformMock.instance = function () {
        ...
        instance.resume.and.returnValue({ subscribe: function () { } });
        // instance.resume.subscribe.and.returnValue(function () { });
        instance.pause.and.returnValue({ subscribe: null });
        // instance.pause.subscribe.and.returnValue(null);
        instance.pause.and.returnValue(Promise.reject());
